...
namespace Wechat4net.QY.Define.PushMessage
{
    ...
    public class File : Base
    {
        ...
        /// 消息类型
        /// </summary>
        internal override string MsgType { get { return "file"; } }
        ...
        /// <param name="mediaId">媒体文件id，可以调用上传媒体文件接口获取</param>
        /// <param name="isSafe">是否加密</param>
        public File(string appId, List<string> toUser, List<string> toParty, List<string> toTag, string mediaId, bool isSafe)
        {
            this.messageType = Enums.QY.PushMessageEnum.File;
            //this.MsgType = "file";
            this.AppID = appId;
