...
namespace Wechat4net.QY.Define.PushMessage
{
    ...
    public class Voice : Base
    {
        ...
        public Voice(string appId, List<string> toUser, List<string> toParty, List<string> toTag, string mediaId, bool isSafe)
        {
            this.messageType = Enums.QY.PushMessageEnum.Voice;
            //this.MsgType = "voice";
            this.AppID = appId;
